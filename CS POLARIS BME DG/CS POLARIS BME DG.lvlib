...
<Library LVVersion="9008000">
	...
	<Item Name="public" Type="Folder">
		...
		<Item Name="CS POLARIS BME DG.constructor.vi" Type="VI" URL="../CS POLARIS BME DG.constructor.vi"/>
		<Item Name="CS POLARIS BME DG.destructor.vi" Type="VI" URL="../CS POLARIS BME DG.destructor.vi"/>
		<Item Name="CS POLARIS BME DG.get data to modify.vi" Type="VI" URL="../CS POLARIS BME DG.get data to modify.vi"/>
		<Item Name="CS POLARIS BME DG.set modified data.vi" Type="VI" URL="../CS POLARIS BME DG.set modified data.vi"/>
	</Item>
	<Item Name="protected" Type="Folder">
		<Property Name="NI.LibItem.Scope" Type="Int">1</Property>
		<Item Name="CS POLARIS BME DG.get i attribute.vi" Type="VI" URL="../CS POLARIS BME DG.get i attribute.vi"/>
		<Item Name="CS POLARIS BME DG.set i attribute.vi" Type="VI" URL="../CS POLARIS BME DG.set i attribute.vi"/>
		<Item Name="CS POLARIS BME DG.ProcCases.vi" Type="VI" URL="../CS POLARIS BME DG.ProcCases.vi"/>
		<Item Name="CS POLARIS BME DG.ProcPeriodic.vi" Type="VI" URL="../CS POLARIS BME DG.ProcPeriodic.vi"/>
	</Item>
