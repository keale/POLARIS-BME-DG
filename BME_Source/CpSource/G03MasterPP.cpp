// G03MasterPP.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CG03MasterPP property page

IMPLEMENT_DYNCREATE(CG03MasterPP, CPropertyPage)

CG03MasterPP::CG03MasterPP() : CPropertyPage(CG03MasterPP::IDD)
{
	//{{AFX_DATA_INIT(CG03MasterPP)
	m_ActivateA = FALSE;
	m_ActivateB = FALSE;
	m_ActivateT0 = FALSE;
	m_DelayA = _T("");
...
CG03MasterPP::~CG03MasterPP()
{
}

void CG03MasterPP::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CG03MasterPP)
...
BEGIN_MESSAGE_MAP(CG03MasterPP, CPropertyPage)
	ON_MESSAGE(WM_LOAD_COUNTER_REQUEST_G03, OnChangeObjectProps)
...
/////////////////////////////////////////////////////////////////////////////
// CG03MasterPP message handlers

LRESULT CG03MasterPP::OnChangeObjectProps(WPARAM, LPARAM)
{
	LoadTriggerCounter(NoEvents);
	return 0;
}

void CG03MasterPP::OnActivateA() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
void CG03MasterPP::OnActivateT0() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
void CG03MasterPP::OnChangeDelayA() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollDelayA(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusDelayA() 
{
	CListRout lr;
...
void CG03MasterPP::OnChangeDelayB() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollDelayB(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusDelayB() 
{
	CListRout lr;
...
void CG03MasterPP::OnChangeDelayT0() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollDelayT0(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusDelayT0() 
{
	CListRout lr;
...
void CG03MasterPP::OnChangeSetBackA() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollSetBackA(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusSetBackA() 
{
	CListRout lr;
...
void CG03MasterPP::OnChangeSetBackB() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollSetBackB(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusSetBackB() 
{
	CListRout lr;
...
void CG03MasterPP::OnChangeSetBackT0() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollSetBackT0(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusSetBackT0() 
{
	CListRout lr;
...
void CG03MasterPP::OnReadTriggers() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
void CG03MasterPP::OnStopOnPreset() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
void CG03MasterPP::OnChangePresetValue() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollPresetValue(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusPresetValue() 
{
	CListRout lr;
...
void CG03MasterPP::OnChangeTriggerPeriod() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollTriggerPeriod(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusTriggerPeriod() 
{
	CListRout lr;
...
void CG03MasterPP::OnChangeTriggerLevel() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollTriggerLevel(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusTriggerLevel() 
{
	CListRout lr;
...
void CG03MasterPP::OnArmByInternal() 
{
	if (b_AllowArmInternal)
	{
		UpdateData(TRUE);
...
void CG03MasterPP::OnGatePositive() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
void CG03MasterPP::OnGateNegative() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
void CG03MasterPP::OnChangeGateDivider() 
{
	UpdateData(TRUE);
	SetModified();
	*p_DataModified = TRUE;
...
LRESULT CG03MasterPP::OnScrollGateDivider(WPARAM, LPARAM)
{
	CListRout lr;
...
void CG03MasterPP::OnKillfocusGateDivider() 
{
	CListRout lr;
...
void CG03MasterPP::OnResetCounter() 
{
	b_RequestZeroCounter = TRUE;
	p_ParentWindow->SendMessage(WM_USER_REQUEST_G03, 0, 0);
}

void CG03MasterPP::OnChangeTriggerCount() 
{
	UpdateData(FALSE);
}

BOOL CG03MasterPP::OnSetActive() 
{
	b_PageActive = TRUE;
	b_FastApply = FALSE;
...
BOOL CG03MasterPP::OnKillActive() 
{
	b_PageActive = FALSE;
	b_FastApply = FALSE;
...
void CG03MasterPP::LoadTriggerCounter(unsigned long TriggerCount)
{
...
void CG03MasterPP::DiscretizeValues()
{
	CListRout lr;
	double t0;
...
BOOL CG03MasterPP::DistributeVariables(DG_Type* p_DG)
{
	double t1;
...
BOOL CG03MasterPP::CollectVariables(DG_Type* p_DG)
{
	//DiscretizeValues();
	CListRout lr;
	CString jstr;
...
void CG03MasterPP::OnShowWindow(BOOL bShow, UINT nStatus) 
{
	...
	case BME_G03V2:
		...
		break;
	case BME_G03V3:
		m_Designator.SetWindowText("G03V4 Delay Parameters");
		break;
	case BME_G03V4:
		m_Designator.SetWindowText("G03V4 Delay Parameters");
		break;
