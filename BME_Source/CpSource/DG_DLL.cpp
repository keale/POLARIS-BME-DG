...
----------------------------------------------------------------------------*/
	...
	#define		DG_DLL_Header			"stdafx2.h"
#else
	#define		DG_DLL_Header			"stdafx.h"
#endif

#include DG_DLL_Header
...
long CDG_DLL::Reserve_DG_Data(long NumberOfDelayGenerators)
{
	int i1;
	p_Internal = new DG_InternalData[max(2, NumberOfDelayGenerators)];
...
long CDG_DLL::Initialize_DG_BME(long base, long Product, long DG_Number)
{
	long BusNumber = -1;
	return Initialize_Bus_DG_BME(BusNumber, base, Product, DG_Number);
}

long CDG_DLL::Initialize_Bus_DG_BME(long BusNumber, long base, long Product, long DG_Number)
{
	char ip_address[40];
...
long CDG_DLL::Initialize_Ethernet_DG_BME(long BusNumber, long base, char* p_ip_address, long Product, long DG_Number)
{
#if (!defined(server) && !defined(D0xConsole))
	RETURN_CODE			rc;
...
long CDG_DLL::ReadCalibrationConstants()
{
	char Path[20];
	Path[0] = 0;
...
long CDG_DLL::ReadPathCalibrationConstants(char* Path)
{
	int i1;
	char* res1;
	char line[200];
...
long CDG_DLL::SaveParameters(DG_BME_State* p_DGS, int NoDelayGenerators, 
...
long CDG_DLL::ReadParameters(DG_BME_State* p_DGS, int* p_module,
														 BOOL* p_CalibrateTiming, unsigned long* p_CalibrationLevel, char* FileName)
{
	...
	if (stream != NULL)
	{
		...
		case 3:
		case 4:
				p_DGS_V1 = new DG_BME_State_V1[max(2, NoDelayGenerators)];
				...
				p_DGS_V2 = new DG_BME_State_V2[max(2, NoDelayGenerators)];
				...
				p_DGS_V3 = new DG_BME_State_V3[max(2, NoDelayGenerators)];
				fseek(stream, position, 0);
				...
				p_DGS_V4 = new DG_BME_State_V4[max(2, NoDelayGenerators)];
				fseek(stream, position, 0);
...
long CDG_DLL::CalibrateModule(long DG_Number)
{
	DG_InternalData* p_Present;
...
long CDG_DLL::UncalibrateModule(long DG_Number)
{
	DG_InternalData* p_Present;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
		return 2;
...
long CDG_DLL::CalibrateGroup(int* p_module)
{
	char Path[20];
	Path[0] = 0;
...
long CDG_DLL::CalibratePathGroup(int* p_module, char* Path)
{
	DG_InternalData* p_Present;
...
long CDG_DLL::Set_DG_BME(DG_BME_Registers* p_pdg, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
...
long CDG_DLL::SetDelayGenerator(DG_BME_Control* p_BDG, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
	double Increment;
...
long CDG_DLL::DelayLimit(double* p_out, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
	double value,Delta;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
...
long CDG_DLL::RoundRepCounter(double* p_out, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
	double Increment;
	int ipos;
...
long CDG_DLL::RoundT0(double* p_out, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
...
long CDG_DLL::RoundWidth(double* p_out, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
	double Increment;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
...
long CDG_DLL::RoundGateDelay(double* p_out, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
	double Increment;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
...
long CDG_DLL::RoundSetBack(double* p_out, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
	double value;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
...
long CDG_DLL::Set_BME_G08(double FireFirst_A, double PulseWidth_A, unsigned long OutputModulo_A,
...
long CDG_DLL::Set_BME_G05(double FireFirst_T0, unsigned long OutputModulo_T0,
...
long CDG_DLL::Set_BME_G03(double FireFirst_T0, double SetBack_T0, BOOL Active_T0, 
...
long CDG_DLL::Set_BME_G02(double FireFirst_T0, BOOL Active_T0, BOOL Positive_T0, 
...
long CDG_DLL::Set_TriggerParameters(BOOL TriggerTerminate, double InternalClock, 
...
long CDG_DLL::Set_G08_TriggerParameters(BOOL GateTerminate, double GateLevel, double GateDelay,
...
long CDG_DLL::Set_V2_TriggerParameters(BOOL IgnoreGate, BOOL SynchronizeGate, double ForceTrigger, 
...
long CDG_DLL::Set_ClockParameters(BOOL ClockEnable, unsigned long DivideBy, unsigned long ClockSource, 
																	long DG_Number)
{
	DG_BME_Control dgc;
	long result;
...
long CDG_DLL::Set_G08_ClockParameters(BOOL ClockEnable, unsigned long OscillatorDivider, 
																				unsigned long TriggerDivider, unsigned long TriggerMultiplier, 
...
long CDG_DLL::Set_Gate_AB(BOOL Gate_AB, long DG_Number)
{
	DG_BME_Control dgc;
	long result;
	DG_InternalData* p_Present;
...
long CDG_DLL::Set_GateFunction(unsigned long GateFunction, long DG_Number)
{
	DG_BME_Control dgc;
	long result;
	DG_InternalData* p_Present;
...
long CDG_DLL::Set_OutputLevel(unsigned long OutputLevel, unsigned long PulseWidth, long DG_Number)
{
	DG_BME_Control dgc;
	long result;
	DG_InternalData* p_Present;
...
long CDG_DLL::Set_G02_Delay(unsigned long Channel, double FireFirst, 
...
long CDG_DLL::Set_G03_Delay(unsigned long Channel, 
...
long CDG_DLL::Set_G05_Delay(unsigned long Channel, double FireFirst, unsigned long OutputModulo,
														BOOL Active, BOOL Positive, BOOL Terminate, BOOL HighDrive,
														long DG_Number)
{
	DelayChannelData* p_ch;
...
long CDG_DLL::Set_G05P2_Delay(unsigned long Channel, double FireFirst, unsigned long OutputModulo,
...
long CDG_DLL::Set_G08_Delay(unsigned long Channel, double FireFirst, double PulseWidth, 
...
long CDG_DLL::Set_CalibrationLevel(unsigned long CalibrationLevel, long DG_Number)
{
	DG_InternalData* p_Present;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
		return 2;
...
long CDG_DLL::Set_CalibrationForAll(unsigned long CalibrationLevel)
{
	long DG_Number;
...
long CDG_DLL::Test_BME_G02(long DG_Number)
{
...
long CDG_DLL::Test_BME_G03(long DG_Number)
{
...
long CDG_DLL::Test_BME_G05(long DG_Number)
{
	double FireFirst_T0 = 3.0;
...
long CDG_DLL::Test_BME_G08(long DG_Number)
{
...
long CDG_DLL::ResetControl(DG_BME_Control* p_DGControl)
{
...
long CDG_DLL::ResetRegisters(DG_BME_Registers* p_DGState)
{
...
long CDG_DLL::ResetState(DG_BME_State* p_DGS)
{
...
long CDG_DLL::CopyState_V1(DG_BME_State* p_DGS, DG_BME_State_V1* p_DGS_V1)
{
	ResetState(p_DGS);
...
long CDG_DLL::CopyState_V2(DG_BME_State* p_DGS, DG_BME_State_V2* p_DGS_V2)
{
	ResetState(p_DGS);
...
long CDG_DLL::CopyState_V3(DG_BME_State* p_DGS, DG_BME_State_V3* p_DGS_V3)
{
	ResetState(p_DGS);
...
long CDG_DLL::CopyState_V4(DG_BME_State* p_DGS, DG_BME_State_V4* p_DGS_V4)
{
	ResetState(p_DGS);
...
long CDG_DLL::CopyControl(DG_BME_Control* p_Control, DG_BME_Control_V1* p_Control_V1)
{
...
long CDG_DLL::CopyControl_V2(DG_BME_Control* p_Control, DG_BME_Control_V2* p_Control_V2)
{
	ResetControl(p_Control);
...
long CDG_DLL::CopyControl_V3(DG_BME_Control* p_Control, DG_BME_Control_V3* p_Control_V3)
{
	ResetControl(p_Control);
...
long CDG_DLL::CopyControl_V4(DG_BME_Control* p_Control, DG_BME_Control_V4* p_Control_V4)
{
	ResetControl(p_Control);
...
long CDG_DLL::Deactivate_DG_BME(long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long cntrl;
	unsigned long DG_Product;
...
long CDG_DLL::Activate_DG_BME(long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
	unsigned long cntrl;
...
long CDG_DLL::SoftwareTrigger_DG_BME(long DG_Number)
{
	unsigned long cntrl;
	DG_InternalData* p_Present;
	unsigned long DG_Product;
...
long CDG_DLL::ResetEventCounter(long DG_Number)
{
	DG_InternalData* p_Present;
...
long CDG_DLL::ResetOutputModuloCounters(long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned short Value;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
...
long CDG_DLL::ResetAllOutputModuloCounters()
{
	DG_InternalData* p_Present;
	unsigned short Value;
	unsigned long DG_Product;
...
long CDG_DLL::JumpStartAllLists()
{
	DG_InternalData* p_Present;
	unsigned short Value;
	unsigned long DG_Product;
...
long CDG_DLL::LoadCardParameters(BOOL b_EventCounter, BOOL b_ModuloCounter, BOOL b_TimeList, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long* p_LoadWord;
	unsigned long DG_Product;
...
long CDG_DLL::LoadAllCardParameters(BOOL b_EventCounter, BOOL b_ModuloCounter, BOOL b_TimeList)
{
	long DG_Number;
	for (DG_Number = 0; DG_Number < NoDelayGenerators; DG_Number++)
...
long CDG_DLL::ResetCounter(BOOL b_EventCounter, BOOL b_ModuloCounter, BOOL b_TimeList, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned short Value;
	unsigned long DG_Product;
...
long CDG_DLL::ResetCounterAllCards(BOOL b_EventCounter, BOOL b_ModuloCounter, BOOL b_TimeList)
{
	long DG_Number;
	for (DG_Number = 0; DG_Number < NoDelayGenerators; DG_Number++)
...
unsigned long CDG_DLL::ReadTriggerCounter(long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
...
long CDG_DLL::Read64BitTriggerCounter(_int64* p_result, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
	unsigned long result = 0;
...
long CDG_DLL::ReadFrequencyCounter(double* p_Frequency, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
	unsigned long result;
...
long CDG_DLL::EnableInterrupts(unsigned long value, long DG_Number)
{
	DG_InternalData* p_Present;
...
unsigned long CDG_DLL::Read_DG_Status(long DG_Number)
{
...
unsigned long CDG_DLL::ReadCounterControlRegister(long DG_Number)
{
	DG_InternalData* p_Present = (p_Internal + DG_Number);
	unsigned long result = 0;
	unsigned long DG_Product = p_Present->DG_Product;
...
unsigned long CDG_DLL::ReadInterruptStatus(long DG_Number)
{
	Register32	tvl;
	DG_InternalData* p_Present = (p_Internal + DG_Number);
	unsigned long result = 0;
...
long CDG_DLL::AcknowledgeInterrupts(unsigned long value, long DG_Number)
{
	unsigned short IntCntrl = (unsigned short) value;
	DG_InternalData* p_Present;
	unsigned long DG_Product;
...
long CDG_DLL::LoadOutputState(long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long cntrl;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
...
unsigned long CDG_DLL::Modify_DG(unsigned long OutputModulo_T0, BOOL Active_T0, 
																 BOOL Positive_T0, BOOL Terminate_T0, BOOL HighDrive_T0,
...
unsigned long CDG_DLL::Modify_DG_V2(unsigned long OutputModulo_T0, 
...
unsigned long CDG_DLL::Modify_G08(unsigned long OutputModulo_A, unsigned long OutputOffset_A, unsigned long GoSignal_A,
...
unsigned long CDG_DLL::ModifyAction(DG_BME_Control* p_BDG, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
...
long CDG_DLL::GetUnconnectedDelayGenerator(long* p_DG_Product, long* p_SlotNumber, long* p_LineMaster, long DG_Number)
{
	long BusNumber;
	return GetUnconnectedBusDelayGenerator(p_DG_Product, &BusNumber, p_SlotNumber, p_LineMaster, DG_Number);
}

long CDG_DLL::GetUnconnectedBusDelayGenerator(long* p_DG_Product, long* p_BusNumber, long* p_SlotNumber, 
...
long CDG_DLL::GetUnconnectedEthernetDelayGenerator(long* p_DG_Product, char* p_IpAddr, long* p_BusNumber, long* p_SlotNumber, 
																							long* p_LineMaster, long DG_Number)
{
	int LineNo;
...
long CDG_DLL::GetPciDelayGenerator(long* p_DG_Product, long* p_SlotNumber, BOOL* p_Master, long DG_Number)
{
	long BusNumber;
...
long CDG_DLL::GetPciBusDelayGenerator(long* p_DG_Product, long* p_BusNumber, long* p_SlotNumber, 
...
long CDG_DLL::GetEthernetDelayGenerator(long* p_DG_Product, char* p_IpAddr, long* p_BusNumber, long* p_SlotNumber,
																			BOOL* p_Master, long DG_Number)
{
	if ((DG_Number >= NumberPciDelayGenerators) || (DG_Number < 0))
		return 2;
...
long CDG_DLL::AddEthernetDelayGenerators(long* p_Error, char* p_IpAddr)
{
	long NoDelgen;
...
long CDG_DLL::DetectPciDelayGenerators(long* p_Error)
{
	long NoDelgen;
	char ip_address[40];
	memset(&(ip_address), 0, (40 * sizeof(char)));
...
long CDG_DLL::DetectEthernetDelayGenerators(long* p_Error, DelgenType* p_DelgenList, char* p_IpAddr)
{
...
long CDG_DLL::DataOut(unsigned short Address, void* p_data, DelgenType* p_PciDelgen, int Size)
{
	int i1,NoBytes;
...
long CDG_DLL::Data32Out(unsigned short Address, void* p_data, DelgenType* p_PciDelgen, int Size)
{
#if (!defined(server) && !defined(D0xConsole))
	//char info[80];
	int Count;
...
long CDG_DLL::DataIn(unsigned short Address, void* p_data, DelgenType* p_PciDelgen, int Size)
{
	int i1,NoBytes;
	unsigned char* p_Value;
...
long CDG_DLL::Data32In(unsigned short Address, void* p_data, DelgenType* p_PciDelgen, int Size)
{
#if (!defined(server) && !defined(D0xConsole))
	int Count;
	U32 PciAddress;
...
long CDG_DLL::ResetPciDelayGenerator(DelgenType* p_PciDelgen)
{
...
BOOL CDG_DLL::MasterDelayGenerator(DelgenType* p_PciMaster, DelgenType* p_PciSlave)
{
...
BOOL CDG_DLL::MasterLineDG(DelgenType* p_PciMaster, DelgenType* p_PciSlave, int LineNo)
{
...
void CDG_DLL::IsaOutByte(unsigned short Address, unsigned char value)
{
...
unsigned char CDG_DLL::IsaInByte(unsigned short Address)
{
	unsigned char value;
#if defined (WINDOWSNT)
	DG_InternalData* p_Present;
...
void CDG_DLL::InitializeInternalData(DG_InternalData* p_Present)
{
...
void CDG_DLL::Synchronize_DG_State(long DG_Number)
{
	DG_BME_Registers dgr;
	DG_InternalData* p_Present;
	unsigned long DG_Product;
...
void CDG_DLL::HardwareTest_BME_G02(long DG_Number)
{
...
void CDG_DLL::HardwareTest_BME_G03(long DG_Number)
{
...
void CDG_DLL::LoadPrescaler(unsigned long* p_value, DG_InternalData* p_Present)
{
	int NumBytes;
...
void CDG_DLL::LoadCounterControl(unsigned long* p_value, DG_InternalData* p_Present)
{
	int NumBytes,i1;
	BOOL different;
	//char info[200];
...
void CDG_DLL::LoadCommandRegister(unsigned long* p_value, DG_InternalData* p_Present)
{
...
void CDG_DLL::SetMainCounterControl(unsigned long* p_Prepare, unsigned long* p_FinalValue, 
...
void CDG_DLL::SetReferenceControl(unsigned long* p_Prepare, unsigned long* p_FinalValue, 
...
void CDG_DLL::SetDelayControl(unsigned long* p_Prepare, unsigned long* p_FinalValue, 
...
void CDG_DLL::SetDelayControl_SG05P4(unsigned long* p_Prepare, unsigned long* p_FinalValue, 
					DelayChannel* p_k, DelayChannel* p_ChState, short int pos, DG_InternalData* p_Present)
{
...
void CDG_DLL::SetDelayTriggerControl(unsigned long* p_Prepare, unsigned long* p_FinalValue, 
...
void CDG_DLL::Set_Main_Counter(MainCounterType* p_mc, DG_InternalData* p_Present)
{
	unsigned long DG_Product;
	if (p_mc->Active)
	{
...
void CDG_DLL::Set_Delay_Trigger(DelayTriggerType* p_dt, unsigned long* p_LoadWord, DG_InternalData* p_Present)
{
...
void CDG_DLL::Set_Reference_channel(DelayChannel* p_rf, DG_InternalData* p_Present)
{
...
void CDG_DLL::Set_Delay_channel(DelayChannel* p_k, DelayChannel* p_ChState, short int pos, 
																															DG_InternalData* p_Present)
{
	unsigned char* pch;
...
void CDG_DLL::Set_Delay_channel_SG05P4(DelayChannel* p_k, DelayChannel* p_ChState, unsigned long* p_LoadWord,
...
void CDG_DLL::PrepareCounterControl(DG_BME_Registers* p_pdg, unsigned long* p_LoadWord, DG_InternalData* p_Present)
{
	unsigned long DG_Product = p_Present->DG_Product;
...
void CDG_DLL::ModifyControlRegister(DG_BME_Registers* p_pdg, DG_InternalData* p_Present)
{
	BOOL SetGate_AB;
	int NoBusLines;
	unsigned long DG_Product = p_Present->DG_Product;
...
long CDG_DLL::Set_DG_BME_Offset(DG_BME_Registers* p_InPdg, BOOL Offset, long DG_Number)
{
	//printf("CDG_DLL::Set_DG_BME \n");
	unsigned long* p_LoadWord;
	DG_InternalData* p_Present = (p_Internal + DG_Number);
	unsigned long DG_Product = p_Present->DG_Product;
	DG_BME_Registers pdg;
	DG_BME_Registers* p_pdg= &pdg;
	memcpy(p_pdg, p_InPdg, sizeof(DG_BME_Registers));
	if (Offset)
	{
		if ((DG_Product == BME_G03V1) || (DG_Product == BME_G03V2))
		{
			p_pdg->T0.Digital = p_pdg->MC.Digital - 10;
		}
		else
			p_pdg->T0.Digital = 10;
	}
...
void CDG_DLL::ActionDC(unsigned long* p_Action, 
...
void CDG_DLL::ActionDT(unsigned long* p_Action, DelayTriggerData* p_a, DelayTriggerData* p_b, unsigned long DG_Product)
{
...
BOOL CDG_DLL::IsEqualDT(DelayTriggerType* p_a, DelayTriggerType* p_b, unsigned long DG_Product)
{
	switch (DG_Product)
	{
	case BME_SG08P1:
...
BOOL CDG_DLL::IsEqualMC(MainCounterType* p_a, MainCounterType* p_b, unsigned long DG_Product)
{
...
BOOL CDG_DLL::IsEqualDC(DelayChannel* p_a, DelayChannel* p_b, unsigned long DG_Product)
{
	int i1;
...
BOOL CDG_DLL::IsEqualPS(DG_BME_Registers* p_a, DG_BME_Registers* p_b, unsigned long DG_Product)
{
	switch (DG_Product)
	{
	case BME_SG08P2:
...
void CDG_DLL::Set_Prescaler(DG_BME_Registers* p_pdg, unsigned long* p_LoadWord, DG_InternalData* p_Present)
{
	unsigned long Value;
...
BOOL CDG_DLL::IsEqual(DG_BME_Registers* p_a, DG_BME_Registers* p_b, unsigned long DG_Product)
{
...
BOOL CDG_DLL::ReadCalibrationFile(FILE *stream, int* p_module, char* FileName)
{
	CStringRout sr;
	DG_InternalData* p_Present;
	DG_InternalData* p_MasterCard;
	...
	while (DG_Number < NoDelayGenerators)
	{
		...
		{
			start = 0;
			npos = sr.NextCharacterGroup(word, line, start);
			start = npos;
			switch (p_Present->DG_Product)
			{
				case BME_G02V1:
...
void CDG_DLL::InitializeCalibrationConstants()
{
	DG_InternalData* p_Present;
	long DG_Number;
	double Factor;
...
void CDG_DLL::DelayChannelTest(DelayChannel* p_dc)
{
	int i1;
...
void CDG_DLL::ResetDelayChannel(DelayChannel* p_dc)
{
	int i1;
	for (i1 = 0; i1 < MemDepth; i1++)
	{
...
void CDG_DLL::ResetMainCounter(MainCounterType* p_mc)
{
	p_mc->Active = FALSE;
...
void CDG_DLL::DelayTriggerTest(DelayTriggerType* p_dt)
{
...
void CDG_DLL::ResetDelayTrigger(DelayTriggerType* p_dt)
{
...
void CDG_DLL::CopyTriggerControl_V4(DelayTriggerData* p_dt, DelayTriggerData_V4* p_dtv4)
{
...
void CDG_DLL::CopyTriggerControl_V3(DelayTriggerData* p_dt, DelayTriggerData_V3* p_dtv3)
{
	ResetTriggerControl(p_dt);
...
void CDG_DLL::CopyTriggerControl_V2(DelayTriggerData* p_dt, DelayTriggerData_V2* p_dtv2)
{
	ResetTriggerControl(p_dt);
...
void CDG_DLL::CopyTriggerControl_V1(DelayTriggerData* p_dt, DelayTriggerData_V1* p_dtv1)
{
	ResetTriggerControl(p_dt);
...
void CDG_DLL::ResetTriggerControl(DelayTriggerData* p_dt)
{
...
void CDG_DLL::CopyDelayControl_V3(DelayChannelData* p_dc, DelayChannelData_V3* p_v3)
{
...
void CDG_DLL::CopyDelayControl_V2(DelayChannelData* p_dc, DelayChannelData_V2* p_v2)
{
	ResetDelayControl(p_dc);
...
void CDG_DLL::ResetDelayControl(DelayChannelData* p_dc)
{
	int i1;
	for (i1 = 0; i1 < MemDepth; i1++)
	{
...
long CDG_DLL::SetTrigger(DG_BME_Registers* p_dgr, DG_BME_Control* p_BDG, long DG_Number)
{
	DG_InternalData* p_Present;
	unsigned long DG_Product;
...
long CDG_DLL::SetReference(DelayChannel* p_a, DelayChannelData* p_dl, 
...
long CDG_DLL::SetChannel(DelayChannel* p_a, DelayChannelData* p_dl, 
															unsigned long MainCounter, long DG_Number)
{
	double Remainder;
	unsigned int IntDelay,IntNumber;
...
long CDG_DLL::SetChannel_SG05P4(DelayChannel* p_a, DelayChannelData* p_dl, long DG_Number)
{
	double Remainder;
...
long CDG_DLL::WidthNumber(unsigned long* p_out, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
	double Increment;
	if ((DG_Number < 0) || (NoDelayGenerators <= DG_Number))
...
long CDG_DLL::DelayNumbers(double* p_remainder, unsigned int* p_digital, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
...
long CDG_DLL::T0Numbers(unsigned int* p_digital, double InValue, long DG_Number)
{
	DG_InternalData* p_Present;
	double value,TestValue,Increment;
	unsigned int IntVal;
